...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x16rpc_verify_email.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xc0\x04\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"G\x92A*\x12\vUpdate User\x1a\x1bUse this API to update user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\x80\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"F\x92A*\x12\n" +
	"Login User\x1a\x1cUse this API to login a user\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x96\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"V\x92A;\x12\fVerify Email\x1a+Use this API to verify user's email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x96\x01\x92Ai\x12g\n" +
	"\x0fSimple Bank API\"O\n" +
	"\fcl-portfolio\x12%https://cl-portfolio-nine.vercel.app/\x1a\x18cyrilelagumbay@gmail.com2\x031.2Z(github.com/projects/go/01_simple_bank/pbb\x06proto3"
